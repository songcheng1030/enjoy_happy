...
Route::controller(LoginController::class)->group(function () {
    ...
    Route::get('membership/{id}', 'membership')->name('user-membership');
    Route::post('membershipcart/{id}', 'membershipCart')->name('user-membershipcart');
    Route::post('membershipfinal', 'payFirstTimePost')->name('firstplan.post');
    Route::post('membershipspecialcode', 'membershipSpecialCode')->name('membershipspecialcode');
    Route::get('paysucc', 'paymentSuccessful')->name('firstplan.paysucc');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(UserController::class)->group(function () {
        ...
        Route::get('/user/specialcode', 'specialCode')->name('user.specialcode');
        ...
        Route::post('/user/storeCode', 'storeCode')->name('user.storecode');
    });
    /**
    |-----------------------------------------------
    | Storemaster Routes.......
    ...
    Route::controller(PhotoController::class)->group(function () {
        ...
        Route::get('/admin/photolist/{group_id}', 'adminEdit')->name('adminedit-photo');
