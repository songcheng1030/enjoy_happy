...
class SendFriendRequest
{
    ...
    { 
        ...
        $requests = Friendrequest::select('id')->where(['request_from' => $this->data()['request_from'], 'request_to' => $this->data()['request_to']])->first();
        if ($requests) {
            return $this;
        }
    ...
    {
        return ['message' => 'friend request sent successfull.!'];
    }
}
