...
class PhotoController extends Controller
{
    ...
    public function getPhotos(Request $request)
    {
        ...
        /*if (1 == Auth::user()->role_id) {
            $photos = Photo::where(['group_id' => $groupId])->get();
        }
        else {*/
        ...
        return view('dashboard.pages.photo.index', compact('groupId', 'group', 'photos', 'groupUsers', 'groupUser', 'groups'));
    }
    ...
    public function adminEdit(Request $request)
    {
        ...
        return view('dashboard.pages.photo.indexadmin', compact('groupId', 'group', 'photos', 'groupUsers', 'groupUser', 'groups'));
    }
}
