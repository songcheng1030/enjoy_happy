                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('adminedit-photo',$result->id) }}" route="{{ route('adminedit-photo',$result->id) }}" id="{{$result->id}}" text="remove level" class="btn btn-sm bg-pink"><span class="badge badge-info">Edit Images</span></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @else
