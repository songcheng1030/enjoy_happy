                    ...
                    <div class="iq-card-body p-0">
                        <div class="user-tabing">
                            <ul class="nav nav-pills d-flex align-items-center justify-content-center profile-feed-items p-0 m-0">
                                ...
                                <li class="col-sm-3 p-0" style="position: relative">
                                    <a class="nav-link" data-toggle="pill" href="#about">About</a>
                                @if (Auth::id() == $user->id) 
                                    <div style="position: absolute; top: 0.5em; left: 13em;">
                                    <a href="{{ route('profile-setting') }}"><img style="width: 50px;" src="{{url('assets/dashboard/images/icon/edit_icon.png')}}" /></a></div>
                                @endif    
                                </li>
                                <li class="col-sm-3 p-0">
...
@endif
                                    ...
                                    <div>
                                        ...
                                        @include('dashboard.layouts.profile_posts')
                    ...
                    <div class="tab-pane fade" id="friends" role="tabpanel">
                        <div class="iq-card">
                            <div class="iq-card-body">
                                ...
                                @php if (count($user->Userfriends) > 0) {   @endphp
                                    ...
                                    @php } 
                                     if (count($user->Userfriends) == 0)
                                            {
echo "<h5>User has no friends.</h5>";
                                            } 
                                        ...
                                        <div class="tab-pane fade active show" id="all-friends" role="tabpanel">
                                            <div class="iq-card-body p-0">
                                                <div class="row">
                                                    ...
                                                    @php
                                                     if (!$friend) { continue; }
                                                     if (!$friend->friendUser) { continue; }
                                                    @endphp
                                                    <div class="col-md-6 col-lg-6 mb-3">
                                                        <div class="iq-friendlist-block" style="border-radius: 10px;">
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                <div class="d-flex align-items-center" >
                                                                    <a href="{{ route('user-profile',encrypt($friend->friendUser->id)) }}">
                                                                        @if(isset($friend->friendUser->userInfo->profile_image) && file_exists('images/profile/'. $friend->friendUser->userInfo->profile_image))
                                                                        <img src="{{ url('images/profile/',$friend->friendUser->userInfo->profile_image) }}" alt="profile-img" style="margin: 10px; width: 7em; height: 7em; border-radius: 50%;" />
                                                                        @else
                                                                        <img src="{{ url('assets/dashboard/img/default-avatar.png') }}" alt="profile-img" style="margin: 8px; width: 7.25em; height: auto" />
                                                                        @endif
                                                                    </a>
                                                                    <div class="friend-info ml-3">
                                                                        <h5><a href="{{ route('user-profile',encrypt($friend->friendUser->id)) }}">{{ ucwords($friend->friendUser->name) }}</a></h5>
