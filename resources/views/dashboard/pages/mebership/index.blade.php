      ...
      <div class="col-lg-12">
        <div class="col-sm-12">
          <div class="iq-card">
            ...
            <a href="{{ route('user.specialcode') }}" class="btn-sm btn-primary btn-md-2 float-right" style="margin-right: 0.3em;">Edit Special Codes<div class="ripple-container"></div></a>
