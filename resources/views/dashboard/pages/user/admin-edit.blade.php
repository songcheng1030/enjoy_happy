		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="iq-edit-list-data">
					<div >
						<div id="personal-information" role="tabpanel">
							<div class="iq-card">
								...
								<div class="iq-card-body">
									<form class="needs-validation" method="post" action="{{ route('admin.update',$admin_user->id) }}" enctype="multipart/form-data" novalidate>
									@csrf
										<div class="form-group row">
											<div class="col-md-9">
												<div class="profile-img-edit">
													@if(isset($admin_user->userInfo->profile_image) && file_exists('images/profile/'. $admin_user->userInfo->profile_image))
													<img class="profile-pic" src="{{ url('images/profile/',$admin_user->userInfo->profile_image) }}" alt="profile-pic">
													@else
											...
											@if ($admin_user->userInfo)
											<div class="d-flex col-md-3 align-top" style="height: 30px;">
												<h5 class="text-center h-switch">Private</h4>
												<label class="switch">
													<input type="checkbox" @if($admin_user->userInfo->status == 1) {{ 'checked=""' }} @endif name="status" value="1">
										...
										<div class=" row align-items-center">
											<div class="form-group col-sm-6">
												...
												<input type="text" class="form-control" id="first_name" name="first_name" value="{{ $admin_user->first_name }}" required>
											</div>
											<div class="form-group col-sm-6">
												<label for="lname">Last Name:</label>
												<input class="form-control" type="text" name="last_name" id="last_name" value="{{ $admin_user->last_name }}" required>
											</div>
											<div class="form-group col-sm-6">
												<label for="uname">Email:</label>
												<input class="form-control" type="email" name="email" id="email" value="{{ $admin_user->email }}" required>
											</div>
								...
								<div class="row">
											...
											@php
											$unformatted_date = isset($user_info->dob) ? $user_info->dob : '';
											$formatted_date = $unformatted_date;
											/*
											echo $user_info->dob; 
											$unformatted_date = explode('-', $unformatted_date);
											print_r($unformatted_date);
											if (isset($unformatted_date[2])) { $formatted_date = $unformatted_date[2]."-".$unformatted_date[0].'-'.$unformatted_date[1]; }
											else { $formatted_date = ''; }
											*/
                                            @endphp
											<div class="form-group col-sm-6">
												...
												<div class="d-flex justify-content-between"> 
													<input type="date" class="form-control" id="birthday" name="dob" value="{{ $formatted_date }}" required>
												</div>
											</div>
											<div class="form-group col-sm-6">
											...
											<div class="form-group col-sm-12">
												...
												<textarea class="form-control" name="address" rows="5" style="line-height: 22px;" name="description" id="description">{{ @$user_info->description }}</textarea>
											</div>
											<div class="form-group col-sm-6">
     ...
     <div class="modal-content">
        ...
        <div class="modal-body">
					<form action="{{ route('admin.upgradeplan.post') }}"  method="post" data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" autocomplete="off" class="require-validation" id="payment-form">
						...
						<input type="hidden" name="meberships_id" id="meberships_id" value="{{ $admin_user->meberships_id }}">
